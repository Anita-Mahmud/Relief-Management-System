...
<div class="card bg-light">
  ...
  <div class="card-body">
    ...
    <h2 class="card-title"><center><b> Welcome admin@gmail.com</b></center></h2>
    <br>
</div>
<center>
<div class="card" style="width: 50rem;">
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><a href="vr.php">Volunteer Registration</a></li>
    <li class="list-group-item"><a href="donation.php">Donation</a></li>
    <li class="list-group-item"><a href="pl.php">Place</a></li>
    <li class="list-group-item"><a href="rel.php">Relief</a></li>
  </ul>
</span>
</div>
</center>
