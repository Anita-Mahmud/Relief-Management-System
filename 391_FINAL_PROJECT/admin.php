...
$queram= "SELECT * FROM admin WHERE email='$username' AND pass = '$pass'";
$connam=mysqli_query($con,$queram);

    
  if(mysqli_num_rows($connam) ==1){
...
<img src="img/bird.png"style="width:100px;height:96px;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-4 my-lg-2">
      ...
      <button class="btn btn-outline-success my-4 my-sm-2" type="submit"><a href="register.php">Register </a> </button>
               ...
               <div class="vol">
                <img src="img/vol1.jpg" height="650vh" width="100%">
                <div class="regbox">
  ...
  <p>Are you an user?<span>Click&nbsp;<a href="login.php">here</a></span></p>
